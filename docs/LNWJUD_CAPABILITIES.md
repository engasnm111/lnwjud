...
สถานะเอกสาร: สรุปจาก source และ runtime contract ปัจจุบันของ lnwjud v5.3.1 (มีทั้งหมด 263 definitions; advertise 251 tools โดยปริยายก่อนใช้ per-tool override และครบ 263 tools เมื่อเปิด Codex delegation กับ Agent Swarm)
