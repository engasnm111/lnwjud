...
สถานะเอกสาร: สรุปจาก source และ runtime contract ปัจจุบันของ lnwjud v4.55.1 (มีทั้งหมด 231 definitions; advertise 224 tools โดยปริยายก่อนใช้ per-tool override และครบ 231 tools เมื่อเปิด Codex delegation กับ Agent Swarm)
