...
- public release ล่าสุด `lnwjud-Setup-5.3.0.exe` หรือ `lnwjud-Portable-5.3.0.exe`
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Setup-5.3.0.exe` จาก GitHub Releases
2. ติดตั้งตามปกติ
...
1. ดาวน์โหลด public release ล่าสุด `lnwjud-Portable-5.3.0.exe`
