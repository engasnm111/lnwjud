...
Status: God-Tier Wave 0–8 additive contract snapshot synchronized for `v4.54.0`.
...
| 87 | `list_goals` | READ | default | operational | service_dispatch | yes | no |
| 88 | `prepare_scheduled_continuation` | WRITE | default | operational | service_dispatch | no | no |
| 89 | `record_scheduled_continuation_receipt` | WRITE | default | operational | service_dispatch | no | no |
| 90 | `claim_scheduled_continuation` | WRITE | default | operational | service_dispatch | no | no |
| 91 | `get_scheduled_continuation` | READ | default | operational | service_dispatch | yes | no |
| 92 | `expedite_scheduled_continuation` | WRITE | default | operational | service_dispatch | no | no |
| 93 | `cancel_scheduled_continuation` | WRITE | default | operational | service_dispatch | no | yes |
| 94 | `symbol_search` | READ | default | operational | service_dispatch | yes | no |
| 95 | `find_definition` | READ | default | operational | service_dispatch | yes | no |
| 96 | `find_references` | READ | default | operational | service_dispatch | yes | no |
| 97 | `find_implementations` | READ | default | operational | service_dispatch | yes | no |
| 98 | `call_hierarchy` | READ | default | operational | service_dispatch | yes | no |
| 99 | `import_graph` | READ | default | operational | service_dispatch | yes | no |
| 100 | `dependency_graph` | READ | default | operational | service_dispatch | yes | no |
| 101 | `module_graph` | READ | default | operational | service_dispatch | yes | no |
| 102 | `type_search` | READ | default | operational | service_dispatch | yes | no |
| 103 | `trace_symbol` | READ | default | operational | service_dispatch | yes | no |
| 104 | `context_ranking` | READ | default | operational | deterministic_operation | yes | no |
| 105 | `debug_context` | READ | default | operational | service_dispatch | yes | no |
| 106 | `review_context` | READ | default | operational | service_dispatch | yes | no |
| 107 | `change_context` | READ | default | operational | service_dispatch | yes | no |
| 108 | `symbol_context` | READ | default | operational | service_dispatch | yes | no |
| 109 | `test_context` | READ | default | operational | service_dispatch | yes | no |
| 110 | `dependency_context` | READ | default | operational | service_dispatch | yes | no |
| 111 | `git_context` | READ | default | operational | service_dispatch | yes | no |
| 112 | `frontend_context` | READ | default | operational | service_dispatch | yes | no |
| 113 | `backend_context` | READ | default | operational | service_dispatch | yes | no |
| 114 | `route_intent` | READ | default | operational | deterministic_operation | yes | no |
| 115 | `recipe_list` | READ | default | operational | deterministic_operation | yes | no |
| 116 | `recipe_describe` | READ | default | operational | deterministic_operation | yes | no |
| 117 | `recipe_run` | EXECUTE | default | operational | deterministic_operation | no | no |
| 118 | `dry_run` | READ | default | operational | deterministic_operation | yes | no |
| 119 | `review_changes` | READ | default | operational | service_dispatch | yes | no |
| 120 | `changed_symbols` | READ | default | operational | service_dispatch | yes | no |
| 121 | `affected_modules` | READ | default | operational | service_dispatch | yes | no |
| 122 | `git_history_context` | READ | default | operational | service_dispatch | yes | no |
| 123 | `git_blame_context` | READ | default | operational | service_dispatch | yes | no |
| 124 | `discover_tests` | READ | default | operational | service_dispatch | yes | no |
| 125 | `run_affected_tests` | EXECUTE | default | operational | service_dispatch | no | no |
| 126 | `test_failures` | READ | default | operational | service_dispatch | yes | no |
| 127 | `coverage_context` | READ | default | operational | service_dispatch | yes | no |
| 128 | `test_history` | READ | default | operational | service_dispatch | yes | no |
| 129 | `cache_stats` | READ | default | operational | deterministic_operation | yes | no |
| 130 | `cache_clear` | WRITE | default | operational | deterministic_operation | no | no |
| 131 | `cache_invalidate` | WRITE | default | operational | deterministic_operation | no | no |
| 132 | `hook_list` | READ | default | operational | deterministic_operation | yes | no |
| 133 | `hook_register` | WRITE | default | operational | deterministic_operation | no | no |
...
| 145 | `session_history` | READ | default | operational | deterministic_operation | yes | no |
| 146 | `response_mode` | READ | default | operational | deterministic_operation | yes | no |
| 147 | `inspect_web_app` | READ | default | operational | service_dispatch | yes | no |
| 148 | `debug_ui` | READ | default | operational | service_dispatch | yes | no |
| 149 | `capture_ui_state` | READ | default | operational | service_dispatch | yes | no |
| 150 | `form_context` | READ | default | operational | service_dispatch | yes | no |
| 151 | `network_context` | READ | default | dependency_gated | truthful_unavailable | yes | no |
| 152 | `console_context` | READ | default | dependency_gated | truthful_unavailable | yes | no |
| 153 | `browser_debug_context` | READ | default | operational | service_dispatch | yes | no |
| 154 | `windows_environment` | READ | default | operational | service_dispatch | yes | no |
| 155 | `service_context` | READ | default | operational | deterministic_operation | yes | no |
| 156 | `process_context` | READ | default | operational | service_dispatch | yes | no |
| 157 | `port_context` | READ | default | operational | deterministic_operation | yes | no |
| 158 | `registry_context` | READ | default | operational | deterministic_operation | yes | no |
| 159 | `event_log_context` | READ | default | operational | deterministic_operation | yes | no |
| 160 | `installed_runtime_context` | READ | default | operational | deterministic_operation | yes | no |
| 161 | `path_context` | READ | default | operational | deterministic_operation | yes | no |
| 162 | `startup_context` | READ | default | operational | deterministic_operation | yes | no |
...
| 191 | `tool_describe` | READ | default | operational | deterministic_operation | yes | no |
| 192 | `tool_categories` | READ | default | operational | deterministic_operation | yes | no |
| 193 | `tool_function_find` | READ | default | operational | deterministic_operation | yes | no |
| 194 | `tool_aliases` | READ | default | operational | deterministic_operation | yes | no |
| 195 | `mcp_hub` | READ | default | dependency_gated | service_dispatch | yes | no |
| 196 | `dev_context` | READ | default | operational | service_dispatch | yes | no |
| 197 | `recipe_catalog` | READ | default | operational | deterministic_operation | yes | no |
| 198 | `capture_screenshot` | READ | default | operational | service_dispatch | yes | no |
| 199 | `compare_screenshot` | READ | default | operational | deterministic_operation | yes | no |
| 200 | `dom_snapshot` | READ | default | operational | service_dispatch | yes | no |
...
| 223 | `db_query` | READ | default | dependency_gated | truthful_unavailable | yes | no |
| 224 | `office_ppt` | WRITE | default | dependency_gated | service_dispatch | no | no |
| 225 | `office_outlook` | READ | default | dependency_gated | service_dispatch | yes | no |
| 226 | `pdf_extract_tables` | READ | default | dependency_gated | truthful_unavailable | yes | no |
