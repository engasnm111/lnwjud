...
| 153 | `windows_environment` | READ | default | operational | truthful_unavailable | yes | no |
| 154 | `service_context` | READ | default | operational | truthful_unavailable | yes | no |
| 155 | `process_context` | READ | default | operational | truthful_unavailable | yes | no |
| 156 | `port_context` | READ | default | operational | truthful_unavailable | yes | no |
| 157 | `registry_context` | READ | default | operational | truthful_unavailable | yes | no |
| 158 | `event_log_context` | READ | default | operational | truthful_unavailable | yes | no |
| 159 | `installed_runtime_context` | READ | default | operational | truthful_unavailable | yes | no |
| 160 | `path_context` | READ | default | operational | truthful_unavailable | yes | no |
| 161 | `startup_context` | READ | default | operational | truthful_unavailable | yes | no |
