...
This complete inventory is generated from `ToolRegistry.listAll()`: **262 total tool definitions**. The runtime advertises **250 tools by default** and **262 tools when Codex delegation plus Agent Swarm is enabled** through `tools/list`.
...
| 48 | `automation_pause` | EXECUTE | default | operational | service_dispatch | no | no |
| 49 | `automation_resume` | EXECUTE | default | operational | service_dispatch | no | no |
| 50 | `shell` | EXECUTE | default | operational | service_dispatch | no | yes |
| 51 | `dom_cdp` | READ | default | operational | service_dispatch | no | yes |
| 52 | `computer_use` | EXECUTE | default | operational | service_dispatch | no | yes |
| 53 | `accessibility` | READ | default | operational | service_dispatch | no | yes |
| 54 | `input_event` | EXECUTE | default | operational | service_dispatch | no | yes |
| 55 | `vision` | READ | default | operational | service_dispatch | yes | no |
| 56 | `vision_annotated_capture` | READ | default | operational | service_dispatch | yes | no |
| 57 | `ui_target_action` | EXECUTE | default | operational | service_dispatch | no | yes |
| 58 | `window` | EXECUTE | default | operational | service_dispatch | no | yes |
| 59 | `health` | READ | default | operational | service_dispatch | yes | no |
| 60 | `system_info` | READ | default | operational | service_dispatch | yes | no |
| 61 | `notification` | EXECUTE | default | operational | service_dispatch | no | no |
| 62 | `file_dialog` | EXECUTE | default | operational | service_dispatch | yes | no |
| 63 | `clipboard` | EXECUTE | default | operational | service_dispatch | no | no |
| 64 | `web_fetch` | READ | default | operational | service_dispatch | no | yes |
| 65 | `audio` | EXECUTE | default | operational | service_dispatch | no | yes |
| 66 | `screen_record` | EXECUTE | default | operational | service_dispatch | no | yes |
| 67 | `office` | WRITE | default | operational | service_dispatch | no | no |
| 68 | `scheduler` | EXECUTE | default | operational | service_dispatch | no | yes |
| 69 | `wsl_exec` | EXECUTE | default | operational | service_dispatch | no | yes |
| 70 | `wsl_fs` | READ | default | operational | service_dispatch | yes | no |
| 71 | `skills_list` | READ | default | operational | service_dispatch | yes | no |
| 72 | `skills_read` | READ | default | operational | service_dispatch | yes | no |
| 73 | `ponytail_session` | WRITE | default | operational | service_dispatch | no | no |
| 74 | `mcp_list` | READ | default | operational | service_dispatch | yes | no |
| 75 | `mcp_describe` | READ | default | operational | service_dispatch | yes | no |
| 76 | `mcp_call` | DANGEROUS | default | operational | service_dispatch | no | yes |
| 77 | `workspace_context` | READ | default | operational | service_dispatch | yes | no |
| 78 | `workspace_context_continue` | READ | default | operational | service_dispatch | yes | no |
| 79 | `workspace_full_scan` | READ | default | operational | service_dispatch | yes | no |
| 80 | `workspace_full_scan_continue` | READ | default | operational | deterministic_operation | yes | no |
| 81 | `workspace_snapshot` | READ | default | operational | service_dispatch | yes | no |
| 82 | `search_all` | READ | default | operational | service_dispatch | yes | no |
| 83 | `read_many_files` | READ | default | operational | service_dispatch | yes | no |
| 84 | `read_file_page` | READ | default | operational | service_dispatch | yes | no |
| 85 | `read_file_page_continue` | READ | default | operational | service_dispatch | yes | no |
| 86 | `workspace_index` | READ | default | operational | service_dispatch | yes | no |
| 87 | `workspace_index_status` | READ | default | operational | service_dispatch | yes | no |
| 88 | `workspace_index_watch` | READ | default | operational | service_dispatch | yes | no |
| 89 | `workspace_index_stop` | READ | default | operational | service_dispatch | yes | no |
| 90 | `session_handoff` | READ | default | operational | service_dispatch | yes | no |
| 91 | `verify_incremental` | EXECUTE | default | operational | service_dispatch | no | no |
| 92 | `run_goal` | WRITE | default | operational | service_dispatch | no | no |
| 93 | `get_goal` | READ | default | operational | service_dispatch | yes | no |
| 94 | `get_goal_plan` | READ | default | operational | service_dispatch | yes | no |
| 95 | `update_goal_plan` | WRITE | default | operational | service_dispatch | no | no |
| 96 | `update_goal_acceptance` | WRITE | default | operational | service_dispatch | no | no |
| 97 | `revise_goal_intent` | WRITE | default | operational | service_dispatch | no | no |
| 98 | `create_context_capsule` | WRITE | default | operational | service_dispatch | no | no |
| 99 | `get_context_capsule` | READ | default | operational | service_dispatch | yes | no |
| 100 | `list_context_capsules` | READ | default | operational | service_dispatch | yes | no |
| 101 | `context_pressure` | READ | default | operational | service_dispatch | yes | no |
| 102 | `record_delivery_receipt` | WRITE | default | operational | service_dispatch | no | no |
| 103 | `list_delivery_receipts` | READ | default | operational | service_dispatch | yes | no |
| 104 | `advance_goal_iteration` | WRITE | default | operational | service_dispatch | no | no |
| 105 | `checkpoint_goal` | WRITE | default | operational | service_dispatch | no | no |
| 106 | `finish_goal` | WRITE | default | operational | service_dispatch | no | no |
| 107 | `cancel_goal` | WRITE | default | operational | service_dispatch | no | yes |
| 108 | `reconcile_goals` | WRITE | default | operational | service_dispatch | no | no |
| 109 | `list_goals` | READ | default | operational | service_dispatch | yes | no |
...
| 247 | `office_outlook` | READ | default | dependency_gated | service_dispatch | yes | no |
| 248 | `pdf_extract_tables` | READ | default | dependency_gated | truthful_unavailable | yes | no |
| 249 | `docx_merge` | WRITE | default | dependency_gated | service_dispatch | no | no |
| 250 | `self_heal_plan` | READ | default | operational | service_dispatch | yes | no |
| 251 | `self_heal_apply` | DANGEROUS | default | dependency_gated | service_dispatch | no | yes |
| 252 | `skills_import` | WRITE | default | operational | service_dispatch | no | no |
| 253 | `ecc_status` | READ | default | operational | deterministic_operation | yes | no |
| 254 | `ecc_catalog` | READ | default | operational | deterministic_operation | yes | no |
| 255 | `ecc_load` | READ | default | operational | truthful_unavailable | yes | no |
| 256 | `ecc_configure` | WRITE | default | operational | truthful_unavailable | no | no |
| 257 | `ecc_security_scan` | EXECUTE | default | dependency_gated | truthful_unavailable | no | no |
| 258 | `ecc_memory_save` | WRITE | default | operational | service_dispatch | no | no |
| 259 | `ecc_memory_search` | READ | default | operational | service_dispatch | yes | no |
| 260 | `ecc_memory_read` | READ | default | operational | service_dispatch | yes | no |
| 261 | `ecc_memory_doctor` | READ | default | operational | service_dispatch | yes | no |
| 262 | `tool_batch` | EXECUTE | default | operational | service_dispatch | no | yes |
