...
`apps/desktop/electron-builder.yml` is the source of truth. The current v5.3.1 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-5.3.1.exe.blockmap
