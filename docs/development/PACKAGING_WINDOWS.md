...
`apps/desktop/electron-builder.yml` is the source of truth. The current v4.52.2 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-4.52.2.exe.blockmap
