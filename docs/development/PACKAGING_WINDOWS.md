...
`apps/desktop/electron-builder.yml` is the source of truth. The current v4.53.0 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-4.53.0.exe.blockmap
