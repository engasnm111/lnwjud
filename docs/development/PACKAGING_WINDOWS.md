...
`apps/desktop/electron-builder.yml` is the source of truth. The current v4.52.1 packaging contract is:
...
apps/desktop/dist/installers/lnwjud-Setup-4.52.1.exe.blockmap
