...
export function createDesktopRuntime(dataPath: string, options: DesktopRuntimeOptions = {}): DesktopRuntime {
  ...
  const requirementDefinitions: readonly RequirementDefinition[] = [
    ...
    { id: 'platform_windows_or_linux', required: false, summaryKey: 'requirement.platform_windows_or_linux', probe: async () => ({ status: process.platform === 'win32' || process.platform === 'linux' ? 'pass' : 'fail', detail: `${process.platform} ${process.arch}` }) },
    ...
    { id: 'native_accessibility', required: false, summaryKey: 'requirement.native_accessibility', remediationId: 'recheck_runtime', platforms: ['win32', 'linux'], probe: () => capabilityRequirement('accessibility') },
    { id: 'native_input', required: false, summaryKey: 'requirement.native_input', remediationId: 'recheck_runtime', platforms: ['win32', 'linux'], probe: () => capabilityRequirement('input_event') },
    { id: 'native_window', required: false, summaryKey: 'requirement.native_window', remediationId: 'recheck_runtime', platforms: ['win32', 'linux'], probe: () => capabilityRequirement('window') },
    { id: 'native_vision', required: false, summaryKey: 'requirement.native_vision', remediationId: 'recheck_runtime', platforms: ['win32', 'linux'], probe: () => capabilityRequirement('vision') },
    { id: 'audio_runtime', required: false, summaryKey: 'requirement.audio_runtime', remediationId: 'recheck_runtime', platforms: ['win32', 'darwin', 'linux'], probe: () => capabilityRequirement('audio') },
    { id: 'screen_record_runtime', required: false, summaryKey: 'requirement.screen_record_runtime', remediationId: 'recheck_runtime', platforms: ['win32', 'darwin', 'linux'], probe: () => capabilityRequirement('screen_record') },
