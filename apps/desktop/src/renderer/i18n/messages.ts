...
export const th: Messages = {
  ...
  'agent.mode': 'Desktop Agent • WORK mode',
  ...
  'guidedTunnel.privacy': 'คีย์จะถูกปกป้องด้วยระบบจัดเก็บข้อมูลลับของระบบปฏิบัติการ (macOS Keychain / Windows DPAPI) และเก็บในเครื่องนี้เท่านั้น lnwjud ไม่มีเซิร์ฟเวอร์กลางรับคีย์ของคุณ',
  ...
  'guidedTunnel.keyStored': 'บันทึกคีย์ในระบบจัดเก็บข้อมูลลับของเครื่องแล้ว',
...
export const en: Messages = {
  ...
  'guidedTunnel.privacy': 'Your key is protected by the operating system credential store (macOS Keychain / Windows DPAPI) and stored only on this computer. lnwjud has no central server that receives your key.',
  ...
  'guidedTunnel.keyStored': 'Key saved in the operating system credential store.',
