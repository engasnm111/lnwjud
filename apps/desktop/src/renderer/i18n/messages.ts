export type MessageKey =
  ...
  | 'settings.saved'
  | 'backup.crossHostNotice'
  | 'backup.crossHostRelink'
  | 'backup.crossHostSecret'
  | 'backup.crossHostLabel'
  | 'badge.unrestricted'
  | 'security.title'
...
export const th: Messages = {
  ...
  'settings.unrestrictedHint': 'อนุญาต absolute path ที่ระบุชัดเจน แต่ไม่สแกนหรือลงทะเบียน filesystem root อัตโนมัติ; กฎยืนยันและ Full Bypass ยังแยกจากกัน',
...
export const en: Messages = {
  ...
  'settings.unrestrictedHint': 'Allows explicitly requested absolute paths without scanning or registering filesystem roots; approval rules and Full Bypass remain separate.',
