...
| 42 | `automation_status` | READ | default | operational | service_dispatch | Read the authoritative durable automation snapshot without advancing or dispatching work. |
