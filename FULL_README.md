...
The v4.60.0 source/release-candidate runtime contract contains **232 total MCP tool definitions**,
...
If you prefer not to install the app, run `lnwjud-Portable-4.60.0.exe` directly.
...
1. แบบแนะนำ: ดาวน์โหลด `lnwjud-Setup-4.60.0.exe` แล้วติดตั้งตามปกติ
2. ถ้าไม่ต้องการติดตั้ง: ดาวน์โหลด `lnwjud-Portable-4.60.0.exe` แล้วเปิดได้ทันที
