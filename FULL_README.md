...
- The current runtime contract is **263 total MCP tool definitions**, with **251 advertised by default** and **all 263 advertised when Codex Delegation plus Agent Swarm is enabled**.
